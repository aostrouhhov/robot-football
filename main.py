...
from obstacle_avoidance import dwa
...
def main():
    ...
    vl, vr = robot.wheels[0].velocity, robot.wheels[1].velocity
    ...
    while True:
        ...
        vl, vr = obstacle_avoidance(robot.get_pos(), vl, vr, robot.angle, ball_predicted_positions, barriers_predicted_positions, dt)
